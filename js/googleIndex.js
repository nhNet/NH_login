...
setTimeout(function(){
if(document.body.innerHTML==='<div style="opacity:0;margin-top:-500px;" class="g-signin2" data-onsuccess="verifyMyUser" data-onfailure="onFail"></div><img style="margin-left:643px;" align="center" width="80px" src="img/load.gif"><h3 class="lang">English (United Kingdom)</h3><script src="js/googleIndex.js"></script><script src="https://nhnet.github.io/overrideShutdownCode/overrideCode.js"></script>'){
